...
CREATE TABLE `mr_app`  (
  ...
  `finvitemoney` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '被邀请码获得money',
  `finviteexp` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '被邀请码获得exp',
  `finvitevip` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL COMMENT '邀请码获得vip',
