/*
 ...
 Source Server         : mrht_moranblog_c
 Source Server Type    : MySQL
 Source Server Version : 50650
 Source Host           : 82.157.121.116:3306
 Source Schema         : mrht_moranblog_c

 Target Server Type    : MySQL
 Target Server Version : 50650
 File Encoding         : 65001

 Date: 09/06/2022 11:31:03
*/
...
CREATE TABLE `mr_app` (
  ...
  `appname` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '名称',
  `appicon` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '图标',
  `introduction` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '简介',
  `author` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '联系方式',
  `group` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '官方群组',
  `userid` int(11) DEFAULT NULL COMMENT '所属用户',
  `title` varchar(255) CHARACTER SET utf8 DEFAULT '暂无' COMMENT '公告标题',
  `content` varchar(255) CHARACTER SET utf8 DEFAULT '暂无' COMMENT '公告内容',
  `version` varchar(255) CHARACTER SET utf8 DEFAULT '1.0' COMMENT '版本号',
  `updatecontent` varchar(255) CHARACTER SET utf8 DEFAULT '暂无' COMMENT '更新内容',
  `download` varchar(255) CHARACTER SET utf8 DEFAULT '暂无' COMMENT '下载地址',
  `creattime` datetime DEFAULT NULL COMMENT '创建时间',
  `zcmoney` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '注册money',
  `zcexp` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '注册经验',
  `zcvip` varchar(255) CHARACTER SET sjis DEFAULT '0' COMMENT '注册会员',
  `signmoney` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '签到money',
  `signexp` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '签到经验',
  `signvip` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '签到会员',
  `postmoney` varchar(255) COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '发帖money',
  `postexp` varchar(255) COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '发帖经验',
  `commentmoney` varchar(255) COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '评论获得money',
  `commentexp` varchar(255) COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '评论获得经验',
  `invitemoney` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `inviteexp` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `invitevip` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `finvitemoney` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `finviteexp` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `finvitevip` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `app_site_status` varchar(255) CHARACTER SET utf8 DEFAULT 'true' COMMENT 'true/false',
  `is_email` varchar(255) CHARACTER SET utf8 DEFAULT 'false' COMMENT '注册是否要验证码true/false',
  `hierarchy` varchar(255) COLLATE utf8_unicode_ci DEFAULT '[0 => ''名称1'',100=>''名称2'',200=>''名称3'',300=>''名称4'',400=>''名称5'']' COMMENT '经验等级划分',
  `view` varchar(255) COLLATE utf8_unicode_ci DEFAULT '0' COMMENT '访问量',
  `devicenum` int(11) NOT NULL DEFAULT '0' COMMENT '每个设备限制几个用户注册0代表无限',
  PRIMARY KEY (`appid`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=10000 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='app列表';
-- ----------------------------
...
CREATE TABLE `mr_user` (
  ...
  `nickname` varchar(50) CHARACTER SET utf8 DEFAULT '这个人没有昵称' COMMENT '昵称',
  `qq` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT 'qq',
  `useremail` varchar(50) CHARACTER SET utf8 NOT NULL COMMENT '邮箱',
  `usertx` varchar(255) CHARACTER SET utf8 DEFAULT './usertx.png' COMMENT '头像',
  `signature` varchar(255) CHARACTER SET utf8 DEFAULT '这个人暂未介绍自己' COMMENT '个性签名',
  `title` varchar(255) CHARACTER SET utf8 DEFAULT '暂无称号' COMMENT '头衔',
  `appid` int(11) DEFAULT NULL COMMENT 'appid',
  `viptime` varchar(11) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'vip时间',
  `money` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '余额',
  `exp` varchar(255) CHARACTER SET utf8 DEFAULT '0' COMMENT '经验',
  `admin` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '是否是管理员',
  `creattime` int(11) DEFAULT NULL COMMENT '注册时间',
  `banned` varchar(255) CHARACTER SET utf8 DEFAULT 'false' COMMENT 'true/false',
  `banned_reason` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT '封禁理由',
  `ip` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT 'ip',
  `user_token` varchar(255) CHARACTER SET utf8 DEFAULT NULL COMMENT 'token',
  `signtime` int(11) DEFAULT '1' COMMENT '签到时间',
  `invitecode` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `invitetotal` varchar(255) COLLATE utf8_unicode_ci DEFAULT '0',
  `inviter` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `device` text COLLATE utf8_unicode_ci,
  `zcdevice` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='用户账号';
